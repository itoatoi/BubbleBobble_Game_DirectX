...
void GameManager::Init()
{
	...
	//for (int i = 0; i < 8; i++)
	//{
	//	sprintf_s(FileName, "./resource/Img/test_tear/tear%02d.png", i + 1);
	//	bbimg[i].Create(FileName, false, D3DCOLOR_XRGB(0, 0, 0));
	//}

	//for (int i = 0; i < 3; i++)
	//{
	//	sprintf_s(FileName, "./resource/Img/test_tear/boom%02d.png", i + 1);
	//	bbpimg[i].Create(FileName, false, D3DCOLOR_XRGB(0, 0, 0));
	//}


	for (int i = 0; i < 10; i++)
	{
		sprintf_s(FileName, "./resource/Img/bubble/%02d.png", i + 1);
		bbimg[i].Create(FileName, false, D3DCOLOR_XRGB(0, 0, 0));
	}

	for (int i = 0; i <40; i++)
	{
		sprintf_s(FileName, "./resource/Img/bubble/pop_%02d.png", i + 1);
		bbpimg[i].Create(FileName, false, D3DCOLOR_XRGB(0, 0, 0));
	}
	...
	for (int i = 0; i < 2; i++)
	{
		sprintf_s(FileName, "./resource/Img/bubble/popop_%02d.png", i + 1);
		bbppimg[i].Create(FileName, false, D3DCOLOR_XRGB(0, 0, 0));
	}
